...
#include <FpyDemo/Top/FpyDemoTopology.hpp>
...
int main(int argc, char* argv[]) {
    ...
    FpyDemo::setupTopology(inputs);
    FpyDemo::startRateGroups(Fw::TimeInterval(1, 0));  // Program loop cycling rate groups at 1Hz
    FpyDemo::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
