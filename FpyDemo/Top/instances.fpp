module FpyDemo {
  ...
  instance blockDrv: FpyDemo.BlockDriver base id 0x10000000 \
  ...
  instance pingRcvr: FpyDemo.PingReceiver base id 0x10004000 \
    queue size Default.QUEUE_SIZE \
    stack size Default.STACK_SIZE \
    priority 100

  instance typeDemo: FpyDemo.TypeDemo base id 0x10005000
  ...
  instance sendBuffComp: FpyDemo.SendBuff base id 0x10010000 \
    queue size Default.QUEUE_SIZE

  instance SG1: FpyDemo.SignalGen base id 0x10011000 \
    queue size Default.QUEUE_SIZE

  instance SG2: FpyDemo.SignalGen base id 0x10012000 \
    queue size Default.QUEUE_SIZE

  instance SG3: FpyDemo.SignalGen base id 0x10013000 \
    queue size Default.QUEUE_SIZE

  instance SG4: FpyDemo.SignalGen base id 0x10014000 \
    queue size Default.QUEUE_SIZE

  instance SG5: FpyDemo.SignalGen base id 0x10015000 \
    queue size Default.QUEUE_SIZE
  ...
  instance recvBuffComp: FpyDemo.RecvBuff base id 0x10022000
