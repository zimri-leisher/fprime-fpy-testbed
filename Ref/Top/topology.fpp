module Ref {
  ...
  topology Ref {
    ...
    connections RateGroups {
      ...
      rateGroup2Comp.RateGroupMemberOut[0] -> ComCcsds.cmdSeq.checkTimers
      rateGroup2Comp.RateGroupMemberOut[4] -> ComCcsds.cmdSeq.tlmWrite
    ...
    connections ComCcsds_CdhCore{
      ...
      ComCcsds.cmdSeq.cmdOut -> CdhCore.cmdDisp.seqCmdBuff
